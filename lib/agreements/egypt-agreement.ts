// ─────────────────────────────────────────────────────────────────────────────
// ROSTER — Egypt Exclusive Artist Management Agreement
// Governing Law: Arab Republic of Egypt
// Law No. 82 of 2002 on the Protection of Intellectual Property Rights · Currency: EGP · Rights Body: ECAD · Tax: ETA · 2026
// ─────────────────────────────────────────────────────────────────────────────
...
export const EGYPT_META = {
  ...
  lawReference: "Law No. 82 of 2002 on the Protection of Intellectual Property Rights",
  taxAuthority: "ETA",
  taxAuthorityFull: "Egyptian Tax Authority (ETA)",
  rightsBody: "ECAD",
  rightsBodyFull: "Egyptian Center for Authors Rights (ECAD)",
  neighbouringRights: "EMPA",
  neighbouringRightsFull: "Egyptian Music Producers Association (EMPA)",
  businessReg: "GAFI",
  businessRegFull: "General Authority for Investment and Free Zones (GAFI)",
  arbitration: "Cairo Regional Centre for International Commercial Arbitration (CRCICA) in Cairo",
  ...
  signatoryRegLabel: "GAFI Registration No.",
  signatoryTaxLabel: "Tax Registration Number (TRN)",
};

export const EGYPT_CLAUSES: Clause[] = [
  {
    id: "1",
    ...
    subclauses: [
      {
        ...
        sub: [
          { ref: "Acts", text: "The Law No. 82 of 2002 on the Protection of Intellectual Property Rights, as amended, and all regulations promulgated thereunder, and includes all applicable performers' protection legislation in Egypt governing the rights of performing artists and producers of sound recordings." },
          { ref: "Artist", text: "The performing artist, recording artist, and vocalist who is a party to this Agreement and who is resident in Egypt." },
          ...
          { ref: "Gross Income", text: "All income generated by the exploitation of the Artist's Services, excluding any amounts paid by a purchaser in respect of production, transport, or other verifiable third-party costs incurred to deliver the Artist's Services, and excluding value-added tax or equivalent indirect tax in Egypt." },
          ...
          { ref: "ECAD", text: "The Egyptian Center for Authors Rights, the performing rights organisation with jurisdiction in Egypt, responsible for collecting and distributing performance and composition royalties." },
          { ref: "EMPA", text: "The Egyptian Music Producers Association, the organisation responsible for collecting neighbouring rights royalties for performing artists and producers of sound recordings in Egypt." },
          ...
          { ref: "ETA", text: "The Egyptian Tax Authority, the tax authority responsible for administering income tax, VAT, and other fiscal obligations in Egypt." },
    ...
    subclauses: [
      {
        ...
        sub: [
          ...
          { ref: "2.1.2", text: "To advise the Artist on market conditions and orientation, including but not limited to: business operating structure and knowledge; technical and production issues; repertoire and creative direction; trends and market intelligence; public profile and image; networking and industry relationships; lifestyle considerations; best practice in the Egypt music industry; market communication and New Media strategy; customer and audience orientation; and collaborations, features, and co-productions." },
      ...
      },
      {
        ...
        sub: [
          ...
          { ref: "2.1.4.9", text: "Promoting and publicising the Artist's name and talents to purchasers, promoters, brands, and industry stakeholders in Egypt and internationally." },
          ...
          { ref: "2.1.4.16", text: "Liaising and directing the preparation of the Artist's accounts receivable and accounts payable, in conjunction with auditors, and maintaining proper books and accounts in accordance with ETA regulations." },
  ...
  },
  {
    ...
    subclauses: [
      ...
      { ref: "3.4", text: "Management shall have no rights to represent the Artist in respect of the Artist's personal banking, medical, private insurance matters, or obligations to ETA (which remain the Artist's direct personal responsibility)." },
    ],
  },
  {
    id: "4",
    ...
    subclauses: [
      ...
      },
      {
        ...
        sub: [
          ...
          { ref: "4.2.4", text: "Management shall maintain, during the Term, proper books of account in accordance with generally accepted accounting principles applicable in Egypt and in compliance with all applicable laws and ETA regulations." },
  ...
  },
  {
    ...
    subclauses: [
      ...
      {
        ref: "6.4",
        text: "The broadening of the Artist's profile in the Egypt market and regionally, with specific emphasis on:",
        sub: [
          { ref: "6.4.1", text: "New Media and social networking opportunities, including digital content strategy." },
          { ref: "6.4.2", text: "Sponsorship, association, and endorsement opportunities with brands active in Egypt and across the Egyptian market." },
          { ref: "6.4.3", text: "Growth of the Artist's New Media following and engagement metrics." },
          { ref: "6.4.4", text: "Collaborations, features, and co-productions with other artists in Egypt and regionally." },
          { ref: "6.4.5", text: "Personality rights licensing across all categories." },
          { ref: "6.4.6", text: "Jingle, advertising, and synchronisation opportunities with Egypt and international brands." },
  ...
  {
    id: "8",
    title: "Sale and Use of the Artist's Services Outside Egypt",
    subclauses: [
  ...
  },
  {
    ...
    subclauses: [
      ...
      { ref: "9.5", text: "Upon the Gross Income accruing to the Artist first exceeding E£ _______________ per month on a consistent basis for three (3) consecutive months, the Artist shall, in consultation with Management and Management's advisors, review and, if appropriate, corporatise the Artist's commercial affairs to ensure statutory compliance and tax efficiency in Egypt as required by ETA." },
    ],
  },
  {
    id: "10",
  ...
  },
  {
    ...
    subclauses: [
      ...
      { ref: "11.2", text: "Management shall maintain proper books and records of account in respect of all marketing and sales of the Artist's Services hereunder, in accordance with applicable Egypt accounting standards and ETA requirements." },
      ...
      { ref: "11.8", text: "If such examination establishes an underpayment to the Artist exceeding the greater of E£ _______________ for the period examined, Management shall pay the reasonable and direct professional costs of the examination (excluding travel, accommodation, and subsistence), not exceeding E£ _______________, which amount shall not be considered in computing the underpayment itself." },
  ...
  },
  {
    ...
    title: "Media",
    subclauses: [
      { ref: "13.1", text: "The Parties agree that media generally, and New Media specifically, are critical for the Artist's communication with fans and industry stakeholders in Egypt and internationally, and are central to the growth of the Artist's Services." },
      ...
      { ref: "13.3", text: "Given the ongoing nature of media interactions relating to the Artist and the Artist's Services, the Artist undertakes, to the best of their ability, to: (i) understand and apply the principles of effective media engagement, including responding directly and constructively to questions; (ii) remain informed on current affairs in the Egypt music industry to respond appropriately and credibly; (iii) present professionally for face-to-face, broadcast, or live digital interactions; (iv) be considerate, respectful, and courteous to interviewers and media representatives; and (v) be punctual for all scheduled media engagements and communicate any delays to Management immediately." },
  ...
  },
  {
    ...
    title: "Tax",
    subclauses: [
      { ref: "14.1", text: "The Parties shall comply with all ETA (Egyptian Tax Authority) regulations concerning the Artist's income tax and any other deductions required under the laws of the Arab Republic of Egypt." },
      { ref: "14.2", text: "The Parties agree to remain compliant at all times during the Term with all ETA regulations concerning the Artist's Net Income, including making requisite deductions, timely payments to ETA, filing all required forms and returns, and maintaining accurate records." },
      { ref: "14.3", text: "The Artist acknowledges that, as a public figure, any breach of ETA regulations or outstanding tax liability may have material and adverse consequences for the Artist's professional reputation and career in Egypt, notwithstanding the terms of this Agreement." },
      { ref: "14.4", text: "VAT is administered by the Egyptian Tax Authority (ETA) at the current statutory rate." },
    ],
  },
  {
    id: "15",
  ...
  },
  {
    ...
    title: "Force Majeure",
    subclauses: [
      { ref: "16.1", text: "If a Party's material performance hereunder is substantially delayed, rendered impossible, or impracticable due to any act of God, fire, earthquake, flood, strike, civil commotion, pandemic, epidemic, governmental acts or restrictions, actions of any relevant performers' association affecting the Artist, Management, or the entertainment industry in Egypt generally, thereby materially hampering Management's exploitation of rights hereunder, the affected Party may, upon prompt written notice to the other, suspend its obligations for the duration thereof." },
      { ref: "16.2", text: "The Term shall be extended by a period equal to any such suspension. Any suspension arising from interference with Management's normal business operations (as opposed to the music industry generally in Egypt) shall not exceed six (6) months in aggregate, after which either Party may terminate this Agreement on thirty (30) days' written notice without further liability for the period of suspension." },
    ],
  },
  {
    id: "17",
    title: "Governing Law",
    subclauses: [
      { ref: "17.1", text: "This Agreement shall be governed by and construed in accordance with the laws of the Arab Republic of Egypt applicable to contracts executed and to be performed wholly therein." },
      { ref: "17.2", text: "The Parties agree that any dispute arising from or in connection with this Agreement shall first be submitted to good-faith negotiation for a period of thirty (30) days. Failing resolution, the dispute shall be submitted to binding arbitration before the Cairo Regional Centre for International Commercial Arbitration (CRCICA) in Cairo, whose award shall be final and binding." },
...
export const EGYPT_SCHEDULE: ScheduleItem[] = [
  {
    ref: "A",
  ...
  {
    ref: "B.3",
    text: "A Management Fee of 20% (twenty per cent) of the Artist's music publishing income (including performance royalties from ECAD, mechanical royalties from the applicable mechanical society, neighbouring rights from EMPA, and sync fees), received directly by the Artist.",
  },
  {
    ref: "B.4",
  ...
  {
    ref: "B.6",
    text: "If Management secures and settles agreements in respect of the Artist's Services in any single calendar month during the Term with third parties, wherein combined receipts to Management and/or the Artist are E£ _______________ or greater (the 'First Threshold'), the Management Fee for income above the First Threshold in that month shall be 22.5% (twenty-two point five per cent), subject to clauses B.7 and B.8 below.",
  },
  {
    ref: "B.7",
    text: "If such combined monthly receipts are E£ _______________ or greater (the 'Second Threshold'), the Management Fee for income above the Second Threshold in that month shall be 25% (twenty-five per cent), subject to clause B.8 below.",
  },
  {
    ref: "B.8",
    text: "If such combined monthly receipts are E£ _______________ or greater (the 'Third Threshold'), the Management Fee for income above the Third Threshold in that month shall be 30% (thirty per cent).",
  },
];
