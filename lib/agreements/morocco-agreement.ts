// ─────────────────────────────────────────────────────────────────────────────
// ROSTER — Morocco Exclusive Artist Management Agreement
// Governing Law: Kingdom of Morocco
// Law No. 2-00 on Copyright and Related Rights (2000, amended 2006) · Currency: MAD · Rights Body: BMDA · Tax: DGI · 2026
// ─────────────────────────────────────────────────────────────────────────────
...
export const MOROCCO_META = {
  ...
  lawReference: "Law No. 2-00 on Copyright and Related Rights (2000, amended 2006)",
  taxAuthority: "DGI",
  taxAuthorityFull: "Direction Générale des Impôts (DGI)",
  rightsBody: "BMDA",
  rightsBodyFull: "Bureau Marocain du Droit d'Auteur (BMDA)",
  neighbouringRights: "BMDA",
  neighbouringRightsFull: "Bureau Marocain du Droit d'Auteur (BMDA)",
  businessReg: "CRI",
  businessRegFull: "Centre Régional d'Investissement (CRI)",
  arbitration: "Centre Marocain de Médiation et d'Arbitrage (CMMA) in Casablanca",
  ...
  signatoryRegLabel: "CRI Registration No.",
  signatoryTaxLabel: "Identifiant Fiscal (IF) / ICE No.",
};

export const MOROCCO_CLAUSES: Clause[] = [
  {
    id: "1",
    ...
    subclauses: [
      {
        ...
        sub: [
          { ref: "Acts", text: "The Law No. 2-00 on Copyright and Related Rights (2000, amended 2006), as amended, and all regulations promulgated thereunder, and includes all applicable performers' protection legislation in Morocco governing the rights of performing artists and producers of sound recordings." },
          { ref: "Artist", text: "The performing artist, recording artist, and vocalist who is a party to this Agreement and who is resident in Morocco." },
          ...
          { ref: "Gross Income", text: "All income generated by the exploitation of the Artist's Services, excluding any amounts paid by a purchaser in respect of production, transport, or other verifiable third-party costs incurred to deliver the Artist's Services, and excluding value-added tax or equivalent indirect tax in Morocco." },
          ...
          { ref: "BMDA", text: "The Bureau Marocain du Droit d'Auteur, the performing rights organisation with jurisdiction in Morocco, responsible for collecting and distributing performance, composition, and neighbouring rights royalties for performing artists and producers of sound recordings." },
          ...
          { ref: "DGI", text: "The Direction Générale des Impôts, the tax authority responsible for administering income tax, TVA, and other fiscal obligations in Morocco." },
    ...
    subclauses: [
      {
        ...
        sub: [
          ...
          { ref: "2.1.2", text: "To advise the Artist on market conditions and orientation, including but not limited to: business operating structure and knowledge; technical and production issues; repertoire and creative direction; trends and market intelligence; public profile and image; networking and industry relationships; lifestyle considerations; best practice in the Morocco music industry; market communication and New Media strategy; customer and audience orientation; and collaborations, features, and co-productions." },
      ...
      },
      {
        ...
        sub: [
          ...
          { ref: "2.1.4.9", text: "Promoting and publicising the Artist's name and talents to purchasers, promoters, brands, and industry stakeholders in Morocco and internationally." },
  ...
  },
  {
    ...
    subclauses: [
      {
        ref: "4.1",
        text: "Artist Warranties — The Artist hereby warrants, represents, and undertakes to Management that:",
        sub: [
      ...
      {
        ref: "4.2",
        text: "Management Warranties — Management hereby warrants, represents, and undertakes to the Artist that:",
        sub: [
          ...
          { ref: "4.2.4", text: "Management shall maintain, during the Term, proper books of account in accordance with generally accepted accounting principles applicable in Morocco and in compliance with all applicable laws and DGI regulations." },
  ...
  },
  {
    ...
    subclauses: [
      ...
      {
        ref: "6.4",
        text: "The broadening of the Artist's profile in the Morocco market and regionally, with specific emphasis on:",
        sub: [
          { ref: "6.4.1", text: "New Media and social networking opportunities, including digital content strategy." },
          { ref: "6.4.2", text: "Sponsorship, association, and endorsement opportunities with brands active in Morocco and across the Moroccan market." },
          { ref: "6.4.3", text: "Growth of the Artist's New Media following and engagement metrics." },
          { ref: "6.4.4", text: "Collaborations, features, and co-productions with other artists in Morocco and regionally." },
          { ref: "6.4.5", text: "Personality rights licensing across all categories." },
          { ref: "6.4.6", text: "Jingle, advertising, and synchronisation opportunities with Morocco and international brands." },
  ...
  {
    id: "8",
    title: "Sale and Use of the Artist's Services Outside Morocco",
    subclauses: [
  ...
  },
  {
    ...
    subclauses: [
      ...
      { ref: "9.5", text: "Upon the Gross Income accruing to the Artist first exceeding MAD _______________ per month on a consistent basis for three (3) consecutive months, the Artist shall, in consultation with Management and Management's advisors, review and, if appropriate, corporatise the Artist's commercial affairs to ensure statutory compliance and tax efficiency in Morocco as required by DGI." },
    ],
  },
  {
    id: "10",
  ...
  },
  {
    ...
    subclauses: [
      ...
      { ref: "11.2", text: "Management shall maintain proper books and records of account in respect of all marketing and sales of the Artist's Services hereunder, in accordance with applicable Morocco accounting standards and DGI requirements." },
      ...
      { ref: "11.8", text: "If such examination establishes an underpayment to the Artist exceeding the greater of MAD _______________ for the period examined, Management shall pay the reasonable and direct professional costs of the examination (excluding travel, accommodation, and subsistence), not exceeding MAD _______________, which amount shall not be considered in computing the underpayment itself." },
  ...
  },
  {
    ...
    subclauses: [
      ...
      {
        ref: "12.2",
        text: "Such post-Term commissions shall be calculated at the following reduced rates of the Management Fee otherwise applicable hereunder, applied to Gross Income from During-Term Exploits only (and excluding any Gross Income from new contracts, engagements, or exploits entered into after the date of termination or expiry of this Agreement):",
        sub: [
  ...
  },
  {
    ...
    title: "Media",
    subclauses: [
      { ref: "13.1", text: "The Parties agree that media generally, and New Media specifically, are critical for the Artist's communication with fans and industry stakeholders in Morocco and internationally, and are central to the growth of the Artist's Services." },
      ...
      { ref: "13.3", text: "Given the ongoing nature of media interactions relating to the Artist and the Artist's Services, the Artist undertakes, to the best of their ability, to: (i) understand and apply the principles of effective media engagement, including responding directly and constructively to questions; (ii) remain informed on current affairs in the Morocco music industry to respond appropriately and credibly; (iii) present professionally for face-to-face, broadcast, or live digital interactions; (iv) be considerate, respectful, and courteous to interviewers and media representatives; and (v) be punctual for all scheduled media engagements and communicate any delays to Management immediately." },
  ...
  },
  {
    ...
    title: "Tax",
    subclauses: [
      { ref: "14.1", text: "The Parties shall comply with all DGI (Direction Générale des Impôts) regulations concerning the Artist's income tax and any other deductions required under the laws of the Kingdom of Morocco." },
      ...
      { ref: "14.3", text: "The Artist acknowledges that, as a public figure, any breach of DGI regulations or outstanding tax liability may have material and adverse consequences for the Artist's professional reputation and career in Morocco, notwithstanding the terms of this Agreement." },
  ...
  },
  {
    ...
    title: "Force Majeure",
    subclauses: [
      { ref: "16.1", text: "If a Party's material performance hereunder is substantially delayed, rendered impossible, or impracticable due to any act of God, fire, earthquake, flood, strike, civil commotion, pandemic, epidemic, governmental acts or restrictions, actions of any relevant performers' association affecting the Artist, Management, or the entertainment industry in Morocco generally, thereby materially hampering Management's exploitation of rights hereunder, the affected Party may, upon prompt written notice to the other, suspend its obligations for the duration thereof." },
      { ref: "16.2", text: "The Term shall be extended by a period equal to any such suspension. Any suspension arising from interference with Management's normal business operations (as opposed to the music industry generally in Morocco) shall not exceed six (6) months in aggregate, after which either Party may terminate this Agreement on thirty (30) days' written notice without further liability for the period of suspension." },
    ],
  },
  {
    id: "17",
    title: "Governing Law",
    subclauses: [
      { ref: "17.1", text: "This Agreement shall be governed by and construed in accordance with the laws of the Kingdom of Morocco applicable to contracts executed and to be performed wholly therein." },
      { ref: "17.2", text: "The Parties agree that any dispute arising from or in connection with this Agreement shall first be submitted to good-faith negotiation for a period of thirty (30) days. Failing resolution, the dispute shall be submitted to binding arbitration before the Centre Marocain de Médiation et d'Arbitrage (CMMA) in Casablanca, whose award shall be final and binding." },
...
export const MOROCCO_SCHEDULE: ScheduleItem[] = [
  {
    ref: "A",
    text: "Support to the Artist by Management",
  },
  {
    ref: "A.1",
  ...
  {
    ref: "B",
    text: "Costs to be Recovered by Management",
  },
  {
    ref: "B.1",
    text: "A Management Fee of 20% (twenty per cent) of Gross Income arising from all live performance, appearance, endorsement, sponsorship, sync licensing, and personality rights engagements, subject to clauses B.5 to B.8 below.",
  },
  {
    ref: "B.2",
  ...
  {
    ref: "B.3",
    text: "A Management Fee of 20% (twenty per cent) of the Artist's music publishing income (including performance royalties from BMDA, mechanical royalties from the applicable mechanical society, neighbouring rights from BMDA, and sync fees), received directly by the Artist.",
  },
  {
    ref: "B.4",
  ...
  {
    ref: "B.6",
    text: "If Management secures and settles agreements in respect of the Artist's Services in any single calendar month during the Term with third parties, wherein combined receipts to Management and/or the Artist are MAD _______________ or greater (the 'First Threshold'), the Management Fee for income above the First Threshold in that month shall be 22.5% (twenty-two point five per cent), subject to clauses B.7 and B.8 below.",
  },
  {
    ref: "B.7",
    text: "If such combined monthly receipts are MAD _______________ or greater (the 'Second Threshold'), the Management Fee for income above the Second Threshold in that month shall be 25% (twenty-five per cent), subject to clause B.8 below.",
  },
  {
    ref: "B.8",
    text: "If such combined monthly receipts are MAD _______________ or greater (the 'Third Threshold'), the Management Fee for income above the Third Threshold in that month shall be 30% (thirty per cent).",
  },
];
