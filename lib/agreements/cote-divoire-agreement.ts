// ─────────────────────────────────────────────────────────────────────────────
// ROSTER — Côte d'Ivoire Exclusive Artist Management Agreement
// Governing Law: Republic of Côte d'Ivoire
// Law No. 2016-555 on Literary and Artistic Property · Currency: XOF · Rights Body: BURIDA · Tax: DGI · 2026
// ─────────────────────────────────────────────────────────────────────────────
...
export const COTE_DIVOIRE_META = {
  flag: "🇨🇮",
  country: "Côte d'Ivoire",
  currency: "XOF",
  currencySymbol: "CFA",
  governingLaw: "the Republic of Côte d'Ivoire",
  lawReference: "Law No. 2016-555 on Literary and Artistic Property",
  taxAuthority: "DGI",
  taxAuthorityFull: "Direction Générale des Impôts (DGI)",
  rightsBody: "BURIDA",
  rightsBodyFull: "Bureau Ivoirien du Droit d'Auteur (BURIDA)",
  neighbouringRights: "BURIDA",
  neighbouringRightsFull: "Bureau Ivoirien du Droit d'Auteur (BURIDA)",
  businessReg: "CEPICI",
  businessRegFull: "Centre de Promotion des Investissements en Côte d'Ivoire (CEPICI)",
  arbitration: "Centre d'Arbitrage, de Médiation et de Conciliation de Côte d'Ivoire (CAMCI) in Abidjan",
  ...
  signatoryRegLabel: "CEPICI Registration No.",
  signatoryTaxLabel: "Numéro de Compte Contribuable (NCC)",
};

export const COTE_DIVOIRE_CLAUSES: Clause[] = [
  {
    id: "1",
    ...
    subclauses: [
      {
        ...
        sub: [
          { ref: "Acts", text: "The Law No. 2016-555 on Literary and Artistic Property, as amended, and all regulations promulgated thereunder, and includes all applicable performers' protection legislation in Côte d'Ivoire governing the rights of performing artists and producers of sound recordings." },
          { ref: "Artist", text: "The performing artist, recording artist, and vocalist who is a party to this Agreement and who is resident in Côte d'Ivoire." },
          ...
          { ref: "Gross Income", text: "All income generated by the exploitation of the Artist's Services, excluding any amounts paid by a purchaser in respect of production, transport, or other verifiable third-party costs incurred to deliver the Artist's Services, and excluding value-added tax or equivalent indirect tax in Côte d'Ivoire." },
          ...
          { ref: "BURIDA", text: "The Bureau Ivoirien du Droit d'Auteur, the performing rights organisation with jurisdiction in Côte d'Ivoire, responsible for collecting and distributing performance, composition, and neighbouring rights royalties for performing artists and producers of sound recordings." },
          ...
          { ref: "DGI", text: "The Direction Générale des Impôts, the tax authority responsible for administering income tax, TVA, and other fiscal obligations in Côte d'Ivoire." },
    ...
    subclauses: [
      {
        ...
        sub: [
          ...
          { ref: "2.1.2", text: "To advise the Artist on market conditions and orientation, including but not limited to: business operating structure and knowledge; technical and production issues; repertoire and creative direction; trends and market intelligence; public profile and image; networking and industry relationships; lifestyle considerations; best practice in the Côte d'Ivoire music industry; market communication and New Media strategy; customer and audience orientation; and collaborations, features, and co-productions." },
      ...
      },
      {
        ...
        sub: [
          ...
          { ref: "2.1.4.9", text: "Promoting and publicising the Artist's name and talents to purchasers, promoters, brands, and industry stakeholders in Côte d'Ivoire and internationally." },
    ...
    subclauses: [
      ...
      },
      {
        ...
        sub: [
          ...
          { ref: "4.2.4", text: "Management shall maintain, during the Term, proper books of account in accordance with generally accepted accounting principles applicable in Côte d'Ivoire and in compliance with all applicable laws and DGI regulations." },
  ...
  },
  {
    ...
    subclauses: [
      ...
      {
        ref: "6.4",
        text: "The broadening of the Artist's profile in the Côte d'Ivoire market and regionally, with specific emphasis on:",
        sub: [
          { ref: "6.4.1", text: "New Media and social networking opportunities, including digital content strategy." },
          { ref: "6.4.2", text: "Sponsorship, association, and endorsement opportunities with brands active in Côte d'Ivoire and across the Ivorian market." },
          { ref: "6.4.3", text: "Growth of the Artist's New Media following and engagement metrics." },
          { ref: "6.4.4", text: "Collaborations, features, and co-productions with other artists in Côte d'Ivoire and regionally." },
          { ref: "6.4.5", text: "Personality rights licensing across all categories." },
          { ref: "6.4.6", text: "Jingle, advertising, and synchronisation opportunities with Côte d'Ivoire and international brands." },
  ...
  {
    id: "8",
    title: "Sale and Use of the Artist's Services Outside Côte d'Ivoire",
    subclauses: [
  ...
  },
  {
    ...
    subclauses: [
      ...
      { ref: "11.2", text: "Management shall maintain proper books and records of account in respect of all marketing and sales of the Artist's Services hereunder, in accordance with applicable Côte d'Ivoire accounting standards and DGI requirements." },
  ...
  },
  {
    ...
    title: "Media",
    subclauses: [
      { ref: "13.1", text: "The Parties agree that media generally, and New Media specifically, are critical for the Artist's communication with fans and industry stakeholders in Côte d'Ivoire and internationally, and are central to the growth of the Artist's Services." },
      ...
      { ref: "13.3", text: "Given the ongoing nature of media interactions relating to the Artist and the Artist's Services, the Artist undertakes, to the best of their ability, to: (i) understand and apply the principles of effective media engagement, including responding directly and constructively to questions; (ii) remain informed on current affairs in the Côte d'Ivoire music industry to respond appropriately and credibly; (iii) present professionally for face-to-face, broadcast, or live digital interactions; (iv) be considerate, respectful, and courteous to interviewers and media representatives; and (v) be punctual for all scheduled media engagements and communicate any delays to Management immediately." },
  ...
  },
  {
    ...
    title: "Tax",
    subclauses: [
      { ref: "14.1", text: "The Parties shall comply with all DGI (Direction Générale des Impôts) regulations concerning the Artist's income tax and any other deductions required under the laws of the Republic of Côte d'Ivoire." },
      ...
      { ref: "14.3", text: "The Artist acknowledges that, as a public figure, any breach of DGI regulations or outstanding tax liability may have material and adverse consequences for the Artist's professional reputation and career in Côte d'Ivoire, notwithstanding the terms of this Agreement." },
      { ref: "14.4", text: "TVA is administered by DGI at the current statutory rate applicable in Côte d'Ivoire." },
    ],
  },
  {
    id: "15",
  ...
  },
  {
    ...
    title: "Force Majeure",
    subclauses: [
      { ref: "16.1", text: "If a Party's material performance hereunder is substantially delayed, rendered impossible, or impracticable due to any act of God, fire, earthquake, flood, strike, civil commotion, pandemic, epidemic, governmental acts or restrictions, actions of any relevant performers' association affecting the Artist, Management, or the entertainment industry in Côte d'Ivoire generally, thereby materially hampering Management's exploitation of rights hereunder, the affected Party may, upon prompt written notice to the other, suspend its obligations for the duration thereof." },
      { ref: "16.2", text: "The Term shall be extended by a period equal to any such suspension. Any suspension arising from interference with Management's normal business operations (as opposed to the music industry generally in Côte d'Ivoire) shall not exceed six (6) months in aggregate, after which either Party may terminate this Agreement on thirty (30) days' written notice without further liability for the period of suspension." },
    ],
  },
  {
    id: "17",
...
export const COTE_DIVOIRE_SCHEDULE: ScheduleItem[] = [
  { ref: "A", text: "Support to the Artist by Management" },
  ...
  { ref: "B", text: "Costs to be Recovered by Management" },
  ...
  { ref: "B.3", text: "A Management Fee of 20% (twenty per cent) of the Artist's music publishing income (including performance royalties from BURIDA, mechanical royalties from the applicable mechanical society, neighbouring rights from BURIDA, and sync fees), received directly by the Artist." },
