// ─────────────────────────────────────────────────────────────────────────────
// ROSTER — Ghana Exclusive Artist Management Agreement
// Governing Law: Republic of Ghana
// Copyright Act 2005 (Act 690) · Currency: GHS · Rights Body: GHAMRO · Tax: GRA · 2026
// ─────────────────────────────────────────────────────────────────────────────
...
export const GHANA_META = {
  ...
  lawReference: "Copyright Act 2005 (Act 690)",
  taxAuthority: "GRA",
  taxAuthorityFull: "Ghana Revenue Authority (GRA)",
  rightsBody: "GHAMRO",
  rightsBodyFull: "Ghana Music Rights Organisation (GHAMRO)",
  neighbouringRights: "GHAMRO",
  neighbouringRightsFull: "Ghana Music Rights Organisation (GHAMRO)",
  businessReg: "RGD",
  businessRegFull: "Registrar General's Department (RGD)",
  arbitration: "Ghana Arbitration Centre (GAC)",
  ...
  signatoryRegLabel: "RGD Registration No.",
  signatoryTaxLabel: "Ghana Revenue Authority (GRA) TIN",
};

export const GHANA_CLAUSES: Clause[] = [
  {
    id: "1",
    ...
    subclauses: [
      {
        ...
        sub: [
          { ref: "Acts", text: "The Copyright Act 2005 (Act 690), as amended, and all regulations promulgated thereunder, and includes all applicable performers' protection legislation in Ghana governing the rights of performing artists and producers of sound recordings." },
          { ref: "Artist", text: "The performing artist, recording artist, and vocalist resident in Ghana named as a party to this Agreement." },
          ...
          { ref: "Gross Income", text: "All income generated by the exploitation of the Artist's Services, excluding any amounts paid by a purchaser in respect of production, transport, or other verifiable third-party costs incurred to deliver the Artist's Services, and excluding value-added tax or equivalent indirect tax in Ghana." },
          ...
          { ref: "GHAMRO", text: "The Ghana Music Rights Organisation, the performing rights organisation with jurisdiction in Ghana, responsible for collecting and distributing performance, composition, and neighbouring rights royalties for performing artists, composers, and producers of sound recordings." },
          ...
          { ref: "GRA", text: "The Ghana Revenue Authority, the tax authority responsible for administering income tax, VAT, and other fiscal obligations in Ghana." },
    ...
    subclauses: [
      {
        ...
        sub: [
          ...
          { ref: "2.1.2", text: "To advise the ARTIST on market conditions and orientation, including but not limited to: business operating structure and knowledge; technical and production issues; repertoire and creative direction; trends and market intelligence; public profile and image; networking and industry relationships; lifestyle considerations; best practice in the Ghana music industry; market communication and New Media strategy; customer and audience orientation; and collaborations, features, and co-productions." },
      ...
      },
      {
        ...
        sub: [
          ...
          { ref: "2.1.4.9", text: "Promoting and publicising the ARTIST's name and talents to purchasers, promoters, brands, and industry stakeholders in Ghana and internationally." },
          ...
          { ref: "2.1.4.16", text: "Liaising and directing the preparation of the ARTIST's accounts receivable and accounts payable, in conjunction with auditors, and maintaining proper books and accounts in accordance with GRA regulations." },
  ...
  },
  {
    ...
    subclauses: [
      ...
      { ref: "3.4", text: "MANAGEMENT shall have no rights to represent the ARTIST in respect of the ARTIST's personal banking, medical, private insurance matters, or obligations to GRA (which remain the ARTIST's direct personal responsibility)." },
    ],
  },
  {
    id: "4",
    ...
    subclauses: [
      ...
      },
      {
        ...
        sub: [
          ...
          { ref: "4.2.4", text: "MANAGEMENT shall maintain, during the Term, proper books of account in accordance with generally accepted accounting principles applicable in Ghana and in compliance with all applicable laws and GRA regulations." },
  ...
  },
  {
    ...
    subclauses: [
      ...
      {
        ref: "6.4",
        text: "The broadening of the ARTIST's profile in the Ghana market and regionally, with specific emphasis on:",
        sub: [
          { ref: "6.4.1", text: "New Media and social networking opportunities, including digital content strategy." },
          { ref: "6.4.2", text: "Sponsorship, association, and endorsement opportunities with brands active in Ghana and across the Ghanaian market." },
          { ref: "6.4.3", text: "Growth of the ARTIST's New Media following and engagement metrics." },
          { ref: "6.4.4", text: "Collaborations, features, and co-productions with other artists in Ghana and regionally." },
          { ref: "6.4.5", text: "Personality rights licensing across all categories." },
          { ref: "6.4.6", text: "Jingle, advertising, and synchronisation opportunities with Ghana and international brands." },
  ...
  {
    id: "8",
    title: "Sale and Use of the Artist's Services Outside Ghana",
    subclauses: [
  ...
  },
  {
    ...
    subclauses: [
      ...
      { ref: "9.5", text: "Upon the Gross Income accruing to the ARTIST first exceeding GH₵ [threshold amount] per month on a consistent basis for three (3) consecutive months, the ARTIST shall, in consultation with MANAGEMENT and MANAGEMENT's advisors, review and, if appropriate, corporatise the ARTIST's commercial affairs to ensure statutory compliance and tax efficiency in Ghana as required by GRA." },
    ],
  },
  {
    id: "10",
  ...
  },
  {
    ...
    subclauses: [
      ...
      { ref: "11.2", text: "MANAGEMENT shall maintain proper books and records of account in respect of all marketing and sales of the Artist's Services hereunder, in accordance with applicable Ghana accounting standards and GRA requirements." },
  ...
  },
  {
    ...
    title: "Media",
    subclauses: [
      { ref: "13.1", text: "The Parties agree that media generally, and New Media specifically, are critical for the ARTIST's communication with fans and industry stakeholders in Ghana and internationally, and are central to the growth of the Artist's Services." },
      ...
      { ref: "13.3", text: "Given the ongoing nature of media interactions relating to the ARTIST and the Artist's Services, the ARTIST undertakes, to the best of their ability, to: (i) understand and apply the principles of effective media engagement, including responding directly and constructively to questions; (ii) remain informed on current affairs in the Ghana music industry to respond appropriately and credibly; (iii) present professionally for face-to-face, broadcast, or live digital interactions; (iv) be considerate, respectful, and courteous to interviewers and media representatives; and (v) be punctual for all scheduled media engagements and communicate any delays to MANAGEMENT immediately." },
  ...
  },
  {
    ...
    title: "Tax",
    subclauses: [
      { ref: "14.1", text: "The Parties shall comply with all GRA (Ghana Revenue Authority) regulations concerning the ARTIST's income tax and any other deductions required under the laws of the Republic of Ghana." },
      { ref: "14.2", text: "The Parties agree to remain compliant at all times during the Term with all GRA regulations concerning the ARTIST's Net Income, including making requisite deductions, timely payments to GRA, filing all required forms and returns, and maintaining accurate records." },
      { ref: "14.3", text: "The ARTIST acknowledges that, as a public figure, any breach of GRA regulations or outstanding tax liability may have material and adverse consequences for the ARTIST's professional reputation and career in Ghana, notwithstanding the terms of this Agreement." },
      { ref: "14.4", text: "VAT is administered by GRA at the current statutory rate. Register for VAT once annual turnover exceeds the GRA threshold." },
    ],
  },
  {
    id: "15",
  ...
  },
  {
    ...
    title: "Force Majeure",
    subclauses: [
      { ref: "16.1", text: "If a Party's material performance hereunder is substantially delayed, rendered impossible, or impracticable due to any act of God, fire, earthquake, flood, strike, civil commotion, pandemic, epidemic, governmental acts or restrictions, actions of any relevant performers' association affecting the ARTIST, MANAGEMENT, or the entertainment industry in Ghana generally, thereby materially hampering MANAGEMENT's exploitation of rights hereunder, the affected Party may, upon prompt written notice to the other, suspend its obligations for the duration thereof." },
      { ref: "16.2", text: "The Term shall be extended by a period equal to any such suspension. Any suspension arising from interference with MANAGEMENT's normal business operations (as opposed to the music industry generally in Ghana) shall not exceed six (6) months in aggregate, after which either Party may terminate this Agreement on thirty (30) days' written notice without further liability for the period of suspension." },
    ],
  },
  {
    id: "17",
    title: "Governing Law",
    subclauses: [
      { ref: "17.1", text: "This Agreement shall be governed by and construed in accordance with the laws of the Republic of Ghana applicable to contracts executed and to be performed wholly therein." },
      { ref: "17.2", text: "The Parties agree that any dispute arising from or in connection with this Agreement shall first be submitted to good-faith negotiation for a period of thirty (30) days. Failing resolution, the dispute shall be submitted to binding arbitration before the Ghana Arbitration Centre (GAC) in Accra, whose award shall be final and binding." },
...
export const GHANA_SCHEDULE: ScheduleItem[] = [
  ...
  { ref: "B.3", text: "A Management Fee of 20% (twenty per cent) of the ARTIST's music publishing income (including performance royalties from GHAMRO, mechanical royalties from the applicable mechanical society, neighbouring rights from GHAMRO, and sync fees), received directly by the ARTIST." },
  ...
  { ref: "B.6", text: "If MANAGEMENT secures and settles agreements in respect of the Artist's Services in any single calendar month during the Term with third parties, wherein combined receipts to MANAGEMENT and/or the ARTIST are GH₵ [First Threshold] or greater, the Management Fee for income above the First Threshold in that month shall be 22.5% (twenty-two point five per cent), subject to clauses B.7 and B.8 below." },
  { ref: "B.7", text: "If such combined monthly receipts are GH₵ [Second Threshold] or greater, the Management Fee for income above the Second Threshold in that month shall be 25% (twenty-five per cent), subject to clause B.8 below." },
  { ref: "B.8", text: "If such combined monthly receipts are GH₵ [Third Threshold] or greater, the Management Fee for income above the Third Threshold in that month shall be 30% (thirty per cent)." },
];
